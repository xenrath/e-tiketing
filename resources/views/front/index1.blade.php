...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('webhost/css/open-iconic-bootstrap.min.css') }}">
  <link rel="stylesheet" href="{{ asset('webhost/css/animate.css') }}">

  <link rel="stylesheet" href="{{ asset('webhost/css/owl.carousel.min.css') }}">
  <link rel="stylesheet" href="{{ asset('webhost/css/owl.theme.default.min.css') }}">
  <link rel="stylesheet" href="{{ asset('webhost/css/magnific-popup.css') }}">

  <link rel="stylesheet" href="{{ asset('webhost/css/aos.css') }}">

  <link rel="stylesheet" href="{{ asset('webhost/css/ionicons.min.css') }}">

  <link rel="stylesheet" href="{{ asset('webhost/css/bootstrap-datepicker.css') }}">
  <link rel="stylesheet" href="{{ asset('webhost/css/jquery.timepicker.css') }}">


  <link rel="stylesheet" href="{{ asset('webhost/css/flaticon.css') }}">
  <link rel="stylesheet" href="{{ asset('webhost/css/icomoon.css') }}">
  <link rel="stylesheet" href="{{ asset('webhost/css/style.css') }}">
</head>
<body>
  ...
  <section class="home-slider owl-carousel">
    <div class="slider-item" style="background-image: url(webhost/images/bg_1.jpg);">
      <div class="overlay"></div>
      <div class="container-fluid">
        <div class="row slider-text align-items-center" data-scrollax-parent="true">

          <div class="col-md-5 wrap col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            <h1 class="mb-4 mt-5" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Everything you get
              what you need to Host your website</h1>
            <p class="mb-4 mb-md-5 sub-p" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Up to 90%
              Discount with Free Domain Name Registration</p>
            <p><a href="#" class="btn btn-primary p-3 px-xl-5 py-xl-3">Get started</a> <a href="#"
                class="btn btn-primary btn-primary-2 p-3 px-xl-5 py-xl-3">Read more</a></p>
          </div>
          <div class="col-md-7 ftco-animate">
            <img src="{{ asset('webhost/images/dashboard_full_1.png') }}" class="img-fluid" alt="">
          </div>
    ...
    <div class="slider-item" style="background-image: url(webhost/images/bg_2.jpg);">
      <div class="overlay"></div>
      <div class="container-fluid">
        <div class="row slider-text align-items-center" data-scrollax-parent="true">

          <div class="col-md-5 wrap col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            <h1 class="mb-4 mt-5" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">The Web Hosting
              Platform Made for You</h1>
          ...
          <div class="col-md-7 ftco-animate">
            <img src="{{ asset('webhost/images/dashboard_full_3.png') }}" class="img-fluid" alt="">
          </div>
    ...
    <div class="container">
      <div class="row d-flex">
        ...
        <div class="col-lg-7 ftco-wrap ftco-animate">
          ...
          <p class="domain-price mt-2"><span><small>.com</small> $9.75</span> <span><small>.net</small> $9.50</span>
            <span><small>.biz</small> $8.95</span> <span><small>.co</small> $7.80</span><span><small>.me</small>
              $7.95</span>
          </p>
        </div>
      </div>
  ...
  <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(webhost/images/bg_1.jpg);"
  ...
  <section class="ftco-services">
    <div class="container-wrap">
      <div class="row no-gutters">
        <div class="col-lg-5 img services-img" style="background-image: url(webhost/images/bg_1.jpg);"
          data-stellar-background-ratio="0.5">
          ...
          <div class="carousel-testimony owl-carousel ftco-owl">
            <div class="item">
              <div class="testimony-wrap p-4 pb-5">
                <div class="user-img mb-5" style="background-image: url(webhost/images/person_1.jpg)">
            ...
            <div class="item">
              <div class="testimony-wrap p-4 pb-5">
                <div class="user-img mb-5" style="background-image: url(webhost/images/person_2.jpg)">
                  <span class="quote d-flex align-items-center justify-content-center">
                    <i class="icon-quote-left"></i>
                  </span>
                </div>
            ...
            <div class="item">
              <div class="testimony-wrap p-4 pb-5">
                <div class="user-img mb-5" style="background-image: url(webhost/images/person_3.jpg)">
                  <span class="quote d-flex align-items-center justify-content-center">
                    <i class="icon-quote-left"></i>
                  </span>
                </div>
        ...
        <div class="col-md-12 nav-link-wrap mb-5 pb-md-5 pb-sm-1 ftco-animate">
          <div class="nav ftco-animate nav-pills justify-content-center text-center" id="v-pills-tab" role="tablist"
            ...
            <a class="nav-link active" id="v-pills-nextgen-tab" data-toggle="pill" href="#v-pills-nextgen" role="tab"
              aria-controls="v-pills-nextgen" aria-selected="true">Next gen VPS</a>

            <a class="nav-link" id="v-pills-performance-tab" data-toggle="pill" href="#v-pills-performance" role="tab"
              aria-controls="v-pills-performance" aria-selected="false">Performance</a>
            ...
            <div class="tab-pane fade show active" id="v-pills-nextgen" role="tabpanel"
              ...
              <div class="d-md-flex">
                <div class="one-forth align-self-center">
                  <img src="{{ asset('webhost/images/dashboard_full_1.jpg') }}" class="img-fluid border" alt="">
                </div>
            ...
            <div class="tab-pane fade" id="v-pills-performance" role="tabpanel"
              ...
              <div class="d-md-flex">
                <div class="one-forth order-last align-self-center">
                  <img src="{{ asset('webhost/images/dashboard_full_2.jpg') }}" class="img-fluid border" alt="">
                </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm ftco-animate">
          <a href="#" class="partner"><img src="{{ asset('webhost/images/partner-1.png') }}" class="img-fluid"
              alt="Colorlib Template"></a>
        </div>
        <div class="col-sm ftco-animate">
          <a href="#" class="partner"><img src="{{ asset('webhost/images/partner-2.png') }}" class="img-fluid"
              alt="Colorlib Template"></a>
        </div>
        <div class="col-sm ftco-animate">
          <a href="#" class="partner"><img src="{{ asset('webhost/images/partner-3.png') }}" class="img-fluid"
              alt="Colorlib Template"></a>
        </div>
        <div class="col-sm ftco-animate">
          <a href="#" class="partner"><img src="{{ asset('webhost/images/partner-4.png') }}" class="img-fluid"
              alt="Colorlib Template"></a>
        </div>
        <div class="col-sm ftco-animate">
          <a href="#" class="partner"><img src="{{ asset('webhost/images/partner-5.png') }}" class="img-fluid"
              alt="Colorlib Template"></a>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-4 ftco-animate">
          <div class="blog-entry">
            <a href="blog-single.html" class="block-20" style="background-image: url('webhost/images/image_1.jpg');">
            </a>
        ...
        <div class="col-md-4 ftco-animate">
          <div class="blog-entry" data-aos-delay="100">
            <a href="blog-single.html" class="block-20" style="background-image: url('webhost/images/image_2.jpg');">
            </a>
            <div class="text d-flex py-4">
              <div class="meta mb-3">
                <div><a href="#">Sep. 20, 2018</a></div>
        ...
        <div class="col-md-4 ftco-animate">
          <div class="blog-entry" data-aos-delay="200">
            <a href="blog-single.html" class="block-20" style="background-image: url('webhost/images/image_3.jpg');">
            </a>
            <div class="text d-flex py-4">
              <div class="meta mb-3">
                <div><a href="#">Sep. 20, 2018</a></div>
